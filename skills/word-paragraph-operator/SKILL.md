...
#### 11. get_paragraph_format_info **[查询]**
...
#### 17. set_paragraph_line_spacing **[操作]**
...
#### 18. set_paragraph_space_before **[操作]**
...
#### 19. set_paragraph_space_after **[操作]**
...
#### 20. set_paragraph_indent_left **[操作]**
...
#### 21. set_paragraph_indent_right **[操作]**
...
#### 22. set_paragraph_first_line_indent **[操作]**
...
#### 23. set_paragraph_hanging_indent **[操作]**
...
#### 24. set_paragraph_outline_level **[操作]**
...
#### 25. set_paragraph_keep_together **[操作]**
...
#### 26. set_paragraph_keep_with_next **[操作]**
...
#### 40. insert_text_before_paragraph **[操作]**
...
#### 41. insert_text_after_paragraph **[操作]**
...
#### 48. split_paragraph_by_separator **[操作]**
...
#### 52. get_paragraph_at_selection **[查询]**
...
| 类型 | 说明 | Action 编号 |
|------|------|-------------|
| **查询类** | 直接调用，无需先查范围。所有按索引查询的方法不需要先调用 `get_paragraph_range` | 1-13, 47, 52 |
| **操作类** | 写入类，会修改文档内容或格式 | 其余编号 |
